                ...
                <div className={bannerHomeStyles.cardsContainer}>
                    <div className={bannerHomeStyles.grid}>
                        ...
                        <div className={`${bannerHomeStyles.cardWrapper} ${bannerHomeStyles.leftCardTransform}`}>
                            ...
                            <p className={`${bannerHomeStyles.cardLabel} ${bannerHomeStyles.cardLabelGray}`}>Classic Heritage</p>
                        </div>
                        ...
                        <div className={`${bannerHomeStyles.cardWrapper} ${bannerHomeStyles.middleCardTransform}`}>
                            ...
                            <p className={`${bannerHomeStyles.cardLabel} ${bannerHomeStyles.cardLabelYellow}`}>Limited Edition</p>
                        </div>

                        {/* Card 3 */}
                        <div className={`${bannerHomeStyles.cardWrapper} ${bannerHomeStyles.rightCardTransform}`}>
                            <div className={`${bannerHomeStyles.cardBase} ${bannerHomeStyles.cardPadding}`}>
                                <img src={BR1} alt="Right Logo" className={`${bannerHomeStyles.cardImage} ${bannerHomeStyles.rightCardImage}`}
                                    loading='lazy' />
                            </div>
                            <p className={`${bannerHomeStyles.cardLabel} ${bannerHomeStyles.cardLabelGray}`}>Modern Precision</p>
                        </div>
                    </div>
                </div>
            </div>
